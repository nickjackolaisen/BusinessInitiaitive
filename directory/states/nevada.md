...
<center>
<img alt="nevada state business directory" src="/images/directory-images/state-headers/nevada-bd-header.png" title="Nevada Business Directory" style="width: 72%; height: 72%">
</center>
...
<a href="{{ '/states/nebraska/counties/' | relative_url }}" class="sos-button">View Nebraska Counties</a>

<a href="{{ site.data.resources.state_sos_websites.nevada }}" target="_blank" class="sos-button">Visit Nevada Secretary of State</a>
