...
Discover the top business startup services in michigan! 
...
<a href="{{ '/states/michigan/counties/' | relative_url }}" class="county-directory-button">View Michigan Counties</a>

<a href="{{ site.data.resources.state_sos_websites.michigan }}" target="_blank" class="sos-button">Visit Michigan Secretary of State</a>
