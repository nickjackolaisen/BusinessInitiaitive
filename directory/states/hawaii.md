...
<a href="{{ '/states/hawaii/counties/' | relative_url }}" class="county-directory-button">View Hawaii Counties</a>

<a href="{{ site.data.resources.state_sos_websites.hawaii }}" target="_blank" class="sos-button">Visit Hawaii Secretary of State</a>
