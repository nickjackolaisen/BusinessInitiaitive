...
<a href="{{ '/states/indiana/counties/' | relative_url }}" class="sos-button">View Indiana Counties</a>

<a href="{{ site.data.resources.state_sos_websites.indiana }}" target="_blank" class="sos-button">Visit Indiana Secretary of State</a>
