...
<center>
<img alt="kansas state business directory" src="/images/directory-images/state-headers/kansas-bd-header.png" title="Kansas Business Directory" style="width: 72%; height: 72%">
</center>
...
<a href="{{ '/states/kansas/counties/' | relative_url }}" class="county-directory-button">View Kansas Counties</a>

<a href="{{ site.data.resources.state_sos_websites.kansas }}" target="_blank" class="sos-button">Visit Kansas Secretary of State</a>
