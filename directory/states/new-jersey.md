...
Discover the top business startup services in New Jersey! 
...
<a href="{{ '/states/new-jersey/counties/' | relative_url }}" class="sos-button">View New Jersey Counties</a>

<a href="{{ site.data.resources.state_sos_websites.new_jersey }}" target="_blank" class="sos-button">Visit New Jersey Secretary of State</a>
