...
<center>
<img alt="alabama state business directory" src="/images/directory-images/state-headers/alabama-bd-header.png" title="Alabama Business Directory" style="width: 72%; height: 72%">
</center>
...
<a href="{{ '/states/alabama/counties/' | relative_url }}" class="sos-button">View Alabama Counties</a>

<a href="{{ site.data.resources.state_sos_websites.alabama }}" target="_blank" class="sos-button">Visit Alabama Secretary of State</a>
