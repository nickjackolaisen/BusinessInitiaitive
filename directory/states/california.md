...
<center>
<img alt="california state business directory" src="/images/directory-images/state-headers/california-bd-header.png" title="California Business Directory" style="width: 72%; height: 72%">
</center>
...
<a href="{{ '/states/california/counties/' | relative_url }}" class="county-directory-button">View California Counties</a>

<a href="{{ site.data.resources.state_sos_websites.california }}" target="_blank" class="sos-button">Visit California Secretary of State</a>
